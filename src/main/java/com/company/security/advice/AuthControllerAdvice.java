...
package com.company.security.advice;
...
public class AuthControllerAdvice {
    ...
    /**
     *  xətalarının siyahısı üçün lokallaşdırılmış mesaj yaratmaq üçün Köməkçi Metod
     */
    ...
    /**
     * Lokallaşdırılmış səhv mesajlarını həll edin. Lokallaşdırılmış xəta yaratmaq üçün kommunal metod
